<!doctype html><html lang="en"><head>
    <meta charset="utf-8">
      ...
      <title>Deprecating Support for Classic/Legacy CRM Cards</title>
    
    <!-- Meta tags -->
    <meta name="description" content="Classic CRM cards, which were static and limited to the right sidebar for a few standard CRM objects, will be phased out starting June 16th, 2025. Developers will no longer be able to add the CRM cards to the HubSpot UI, and any new app added to the HubSpot App Marketplace will not be allowed to include Classic CRM Cards when seeking listing and certification for their app. Existing apps in the App Marketplace that currently include Classic CRM Cards will not be affected and will have until October 31, 2026, to migrate their existing cards to the Interactive App Cards built with React.">
    ...
    <meta property="og:description" content="Classic CRM cards, which were static and limited to the right sidebar for a few standard CRM objects, will be phased out starting June 16th, 2025. Developers will no longer be able to add the CRM cards to the HubSpot UI, and any new app added to the HubSpot App Marketplace will not be allowed to include Classic CRM Cards when seeking listing and certification for their app. Existing apps in the App Marketplace that currently include Classic CRM Cards will not be affected and will have until October 31, 2026, to migrate their existing cards to the Interactive App Cards built with React.">
    <meta property="og:title" content="Deprecating Support for Classic/Legacy CRM Cards">
    <meta name="twitter:description" content="Classic CRM cards, which were static and limited to the right sidebar for a few standard CRM objects, will be phased out starting June 16th, 2025. Developers will no longer be able to add the CRM cards to the HubSpot UI, and any new app added to the HubSpot App Marketplace will not be allowed to include Classic CRM Cards when seeking listing and certification for their app. Existing apps in the App Marketplace that currently include Classic CRM Cards will not be affected and will have until October 31, 2026, to migrate their existing cards to the Interactive App Cards built with React.">
    <meta name="twitter:title" content="Deprecating Support for Classic/Legacy CRM Cards">
...
<link rel="preload" as="style" href="https://developers.hubspot.com/hubfs/raw_assets/Developers-website-2025-theme/145/js_client_assets/assets/index-Dw3V0FIG.css">
    ...
    <script src="https://www.hubspot.com/wt-assets/static-files/global-scripts/latest/personalization/index.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
...
<meta name="twitter:card" content="summary_large_image">
  ...
  <script defer src="https://www.hubspot.com/wt-assets/static-files/compliance/index.js" data-gtm-id="GTM-55897XN" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
...
<meta class="swiftype" name="meta-description" data-type="text" content="Classic CRM cards, which were static and limited to the right sidebar for a few standard CRM objects, will be phased out starting June 16th, 2025. Developers will no longer be able to add the CRM cards to the HubSpot UI, and any new app added to the HubSpot App Marketplace will not be allowed to include Classic CRM Cards when seeking listing and certification for their app. Existing apps in the App Marketplace that currently include Classic CRM Cards will not be affected and will have until October 31, 2026, to migrate their existing cards to the Interactive App Cards built with React."><meta class="swiftype" name="last-updated" data-type="date" content="%2025-%34-%17"><meta name="google-site-verification" content="gcKBykimmsbADokTIYhnTQ_lRNvSqLFZnkQp4cVW84g">
<link rel="amphtml" href="https://developers.hubspot.com/changelog/deprecating-support-for-classic-crm-cards?hs_amp=true">

<meta property="og:url" content="https://developers.hubspot.com/changelog/deprecating-support-for-classic-crm-cards">
<meta name="twitter:card" content="summary">
<meta name="twitter:creator" content="@TechWithHannah">

<link rel="canonical" href="https://developers.hubspot.com/changelog/deprecating-support-for-classic-crm-cards">
...
<meta name="generator" content="HubSpot"></head><body class="  hs-content-id-190158822775 hs-blog-post hs-content-path-changelog-deprecating-support-for-classic-crm-card hs-content-name-deprecating-support-for-classic-legacy-crm-cards hs-blog-name-developer-changelog hs-blog-id-29973821837" data-theme-id="212471405130" data-theme-project-id="101734284" data-theme-build-id="145" data-cl-brand="hubspot-2025" data-cl-theme="light"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-cl-version="3.19.0" style="display: none;">
...
<header class="global-nav-header"><section class="section-width"><div class="global-nav-header-top-bar"><nav class="top-bar-nav"><!--$--><div data-hs-island="true" id="island-906b21n329c0bR5"><!--$--><div data-menu-type="utilNav"><ul class="nav-list nav-list--utilNav"><li class="nav-item nav-item--link"><a href="/changelog" class="nav-link  ">Changelog</a></li><li class="nav-item nav-item--link"><a href="/blog" class="nav-link  ">Blog</a></li><li class="nav-item nav-item--link"><a href="/docs" class="nav-link  ">Docs</a></li></ul></div><!--/$--></div><!--/$--><!--$--><div data-hs-island="true" id="island-906b21n329c0bR9"><!--$--><div data-menu-type="topNav"><ul class="nav-list nav-list--topNav"><li class="nav-item nav-item--link"><a href="https://status.hubspot.com" class="nav-link status-indicator ">Status</a></li></ul></div><!--/$--></div><!--/$--></nav></div><div class="global-nav-header-bottom-bar"><nav class="bottom-bar-nav"><!--$--><div data-hs-island="true" id="island-906b21n329c0bR2"><!--$--><div data-menu-type="megaNav" class="mega-nav-container"><div class="mega-nav-mobile-view" style="display:flex"><div class="mobile-nav-logo"><a href="/" aria-label="HubSpot Developers Logo" class="logo-item flex-none mr-6 " style="width:250px;display:block"><svg width="100%" viewbox="0 0 342 89" role="img"><use href="#sprocket-developers-orange"></use></svg></a></div><button class="candy-box-icon" aria-label="Open navigation menu" aria-expanded="false"><svg width="40" height="40" viewbox="0 0 24 24" fill="currentColor"><circle cx="6" cy="6" r="2"></circle><circle cx="12" cy="6" r="2"></circle><circle cx="18" cy="6" r="2"></circle><circle cx="6" cy="12" r="2"></circle><circle cx="12" cy="12" r="2"></circle><circle cx="18" cy="12" r="2"></circle><circle cx="6" cy="18" r="2"></circle><circle cx="12" cy="18" r="2"></circle><circle cx="18" cy="18" r="2"></circle></svg></button></div><div class="mega-nav-desktop-view" style="display:none"><nav aria-label="Main" data-orientation="horizontal" dir="ltr" class="relative z-10"><div style="position:relative"><ul data-orientation="horizontal" class="group flex flex-1 list-none items-center justify-between space-x-1" dir="ltr"><li class="nav-item nav-item--logo" data-item-type="logo"><a href="/" aria-label="HubSpot Developers Logo" class="logo-item flex-none mr-6 " style="width:250px;display:block" data-radix-collection-item=""><svg width="100%" viewbox="0 0 342 89" role="img"><use href="#sprocket-developers-orange"></use></svg></a></li><li class="nav-item nav-item--link"><button id="radix-:island-906b21n329c0bR2-R2:-trigger-item-1" data-state="closed" aria-expanded="false" aria-controls="radix-:island-906b21n329c0bR2-R2:-content-item-1" class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group" data-radix-collection-item="">Get Started<!-- --> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button></li><li class="nav-item nav-item--link"><button id="radix-:island-906b21n329c0bR2-R2:-trigger-item-2" data-state="closed" aria-expanded="false" aria-controls="radix-:island-906b21n329c0bR2-R2:-content-item-2" class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group" data-radix-collection-item="">Apps<!-- --> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button></li><li class="nav-item nav-item--link"><button id="radix-:island-906b21n329c0bR2-R2:-trigger-item-3" data-state="closed" aria-expanded="false" aria-controls="radix-:island-906b21n329c0bR2-R2:-content-item-3" class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group" data-radix-collection-item="">CMS<!-- --> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button></li><li class="nav-item nav-item--link"><button id="radix-:island-906b21n329c0bR2-R2:-trigger-item-4" data-state="closed" aria-expanded="false" aria-controls="radix-:island-906b21n329c0bR2-R2:-content-item-4" class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group" data-radix-collection-item="">Tooling<!-- --> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button></li><li class="nav-item nav-item--link"><button id="radix-:island-906b21n329c0bR2-R2:-trigger-item-5" data-state="closed" aria-expanded="false" aria-controls="radix-:island-906b21n329c0bR2-R2:-content-item-5" class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group" data-radix-collection-item="">Marketplace<!-- --> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button></li><li class="nav-item nav-item--button" data-item-type="button"><a href="https://app.hubspot.com/signup-hubspot/crm?intent=developer" class="nav-button cl-button -primary -small -primary -small " aria-label="Create developer account with a HubSpot Developer account" data-radix-collection-item="">Create developer account<span class="sr-only"> <!-- -->with a HubSpot Developer account</span></a></li></ul></div><div class="absolute left-0 top-full flex justify-center menu-dropdown-container"></div></nav></div></div><!--/$--></div><!--/$--></nav></div></section></header>
    <script type="text/javascript" nonce="edVKcqp1NO1p/3x9J5++Tg==">
      ...
      window.__hsServerPageUrl = "https:\u002F\u002Fdevelopers.hubspot.com\u002Fchangelog\u002Fdeprecating-support-for-classic-crm-cards";
      window.__hsBasePath = "\u002Fchangelog\u002Fdeprecating-support-for-classic-crm-cards";
    </script>
  ...
  <script type="module" crossorigin nonce="edVKcqp1NO1p/3x9J5++Tg==">
...
<div class="_breadcrumb_container_vb0nh_1"><ul aria-label="Breadcrumb" role="navigation" class="_breadcrumb_list_vb0nh_10"><li><a style="text-decoration:underline" href="/">Home</a></li><li><span>›</span></li><li><a style="text-decoration:underline" href="https://developers.hubspot.com/changelog">HubSpot Developer Changelog</a></li><li><span>›</span></li><li><strong><span>Deprecating Support for Classic/Legacy CRM Cards</span></strong></li></ul></div>
    <script type="text/javascript" nonce="edVKcqp1NO1p/3x9J5++Tg==">
      window.__hsEnvConfig = {"hsDeployed":true,"hsEnv":"prod","hsJSRGates":["CMS:JSRenderer:SeparateIslandRenderOption","CMS:JSRenderer:GetServerSideProps","CMS:JSRenderer:EnvAllowlist"],"hublet":"na1","portalID":53};
      window.__hsServerPageUrl = "https:\u002F\u002Fdevelopers.hubspot.com\u002Fchangelog\u002Fdeprecating-support-for-classic-crm-cards";
      window.__hsBasePath = "\u002Fchangelog\u002Fdeprecating-support-for-classic-crm-cards";
  ...
  <div class="cl-section -padding-top-medium -padding-bottom-medium" data-cl-theme="light">
    <div class="cl-section-content">
      <h1 class="cl-h1"><span id="hs_cos_wrapper_name" class="hs_cos_wrapper hs_cos_wrapper_meta_field hs_cos_wrapper_type_text" data-hs-cos-general-type="meta_field">Deprecating Support for Classic/Legacy CRM Cards</span></h1>
      <div class="developersBlog-blog-metadata">
        <p class="developersBlog-post-content-dates">
          <time datetime="May 15, 2025">Announced: May 15, 2025</time>
          
          
            
            <br>
            <time datetime="Jun 16, 2025">Live: Jun 16, 2025</time>
          
        </p>
      </div>
      <article class="developersBlog-blog-content">
        <span id="hs_cos_wrapper_post_body" class="hs_cos_wrapper hs_cos_wrapper_meta_field hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="meta_field" data-hs-cos-type="rich_text"><p>Starting <span style="font-weight: bold;">June 16th, 2025</span>, Classic CRM cards will no longer be supported due to the upcoming sunset of <a href="/docs/guides/api/crm/extensions/crm-cards" rel="noopener" target="_blank">Classic CRM Cards</a>, which will occur on <span style="font-weight: bold;">October 31st,</span> <span style="font-weight: bold;">2026</span>. The CRM card feature has been a cornerstone of our CRM system for over a decade. As part of our ongoing commitment to innovation and delivering modern solutions, we are shifting our focus towards more advanced and <a href="/docs/guides/crm/overview#get-started" rel="noopener" target="_blank">interactive App Cards</a> built with React. This change is driven by newer UI extension capabilities, which have shown significant developer interest and engagement, indicating a future-ready pathway.</p>
<!--more-->
<h2>What's changing?</h2>
<p>These Classic CRM cards, which were static and limited to the right sidebar for a few standard CRM objects, will be phased out starting June 16th, 2025. Developers will no longer be able to add the CRM cards to the HubSpot UI, and any new app added to the <a href="https://ecosystem.hubspot.com/marketplace/apps" rel="noopener" target="_blank">HubSpot App Marketplace</a> will not be allowed to include Classic CRM Cards when seeking listing and certification for their app. Existing apps in the App Marketplace that currently include Classic CRM Cards will not be affected and will have until October 31, 2026, to migrate their existing cards to the Interactive App Cards built with React.</p>
<h2>What does this mean for developers?</h2>
<p><span style="background-color: transparent; font-size: 16px;">Due to the deprecation of these legacy features, developers currently utilizing Classic CRM Cards will need to transition their solutions to&nbsp;</span><a href="https://developers.hubspot.com/docs/guides/crm/public-apps/migrate-a-public-app-to-projects" target="_blank" style="background-color: transparent; font-size: 16px;" rel="noopener">App Cards</a><span style="background-color: transparent; font-size: 16px;">&nbsp;by October 31st, 2026</span>. App Cards provide&nbsp;enhanced capabilities, offering dynamic interactions and greater flexibility than Classic CRM Cards' static and limited functionalities. This transition will ensure a future-proof path for your applications.&nbsp;</p>
<p>Support resources will be available later this year, in <span style="font-weight: bold;">November 2025</span>, to assist with this process and facilitate an efficient migration. In addition, developers can begin using the new Legacy CRM Card Converter, which provides an example implementation and guidance for converting Classic CRM Cards into modern App Cards. You can find it here: <a href="https://github.com/HubSpot/ui-extensions-examples/tree/main/legacy-card-converter">https://github.com/HubSpot/ui-extensions-examples/tree/main/legacy-card-converter</a>&nbsp;&nbsp;</p>
<p>Utilize available resources and support materials:&nbsp;</p>
<ul>
<li aria-level="1"><a href="/docs/guides/crm/overview#ui-customization-overview-beta" rel="noopener" target="_blank">UI customization overview (BETA)</a></li>
<li aria-level="1"><a href="/docs/guides/crm/ui-extensions/overview#ui-extensions-overview-beta" rel="noopener" target="_blank">UI Extensions overview (BETA)</a></li>
<li aria-level="1"><a href="/docs/guides/crm/ui-extensions/create" rel="noopener" target="_blank">Create UI extensions with React (BETA)</a></li>
<li aria-level="1"><a href="/docs/guides/crm/public-apps/migrate-a-public-app-to-projects" rel="noopener" target="_blank">Migrate a public app to the developer projects framework (BETA)</a></li>
<li aria-level="1"><a href="https://github.com/HubSpot/ui-extensions-examples/tree/main/legacy-card-converter" rel="noopener" target="_blank"><strong>Legacy CRM Card Converter <span style="color: #ff4800;">(NEW)</span></strong></a> - GitHub sample and tooling for migrating Classic CRM Cards</li>
</ul>
<p>By transitioning, you will future-proof your applications and enjoy improved functionality and support. As we approach the official sunset date in 2026, more migration assistance will be shared via our <a href="/changelog" rel="noopener" target="_blank">Developer Changelog</a>, so please be sure to subscribe.</p>
<h2>When is it happening?</h2>
<p>Starting <span style="font-weight: bold;">June 16th, 2025</span>, no new apps containing a Classic CRM Card within the App Marketplace will be listed or certified, and no new Legacy CRM Cards will be able to be added to the HubSpot UI.&nbsp;&nbsp;<span style="font-weight: bold;">Existing apps containing Classic CRM cards will have until October 31st, 2026</span>, to migrate their existing cards.</p>
<p><span style="font-weight: bold;">Questions or comments? </span>Join us in the <a href="https://community.hubspot.com/t5/Developer-Announcements/Deprecating-Support-for-Classic-Legacy-CRM-Cards/m-p/1153039#M1048" rel="noopener" target="_blank">developer forums</a> or the <a href="https://hubspotdev.slack.com/archives/C05R599UA12" target="_blank" rel="noopener">#ask-ui-extensions</a> channel on the <a href="/slack" rel="noopener" target="_blank">HubSpot Developer Slack</a> to connect with other developers and share how you’re transitioning to the newer App Cards.</p></span>
      </article>
    </div>
  </div>
...
<script defer src="/hs/hsstatic/content-cwv-embed/static-1.1293/embed.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<script src="https://developers.hubspot.com/hubfs/hub_generated/template_assets/1/80991207740/1775052615696/template_icons.min.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<script nonce="edVKcqp1NO1p/3x9J5++Tg==">
var hsVars = hsVars || {}; hsVars['language'] = 'en';
</script>

<script src="/hs/hsstatic/cos-i18n/static-1.53/bundles/project.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
...
<script src="https://developers.hubspot.com/hubfs/hub_generated/template_assets/1/206749040455/1775052649814/template_cl-icon.mount.min.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<script src="https://developers.hubspot.com/hubfs/hub_generated/template_assets/145/212471405146/1778185516249/template_prism.min.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<script type="module" src="https://developers.hubspot.com/hubfs/hub_generated/template_assets/145/212471405147/1778185516254/template_code-block-webcomponent.min.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<script nonce="edVKcqp1NO1p/3x9J5++Tg==">
var hsVars = hsVars || {}; hsVars['language'] = 'en';
</script>
...
_hsq.push(["setCanonicalUrl", "https:\/\/developers.hubspot.com\/changelog\/deprecating-support-for-classic-crm-cards"]);
_hsq.push(["setPageId", "190158822775"]);
_hsq.push(["setContentMetadata", {
    "contentPageId": 190158822775,
    "legacyPageId": "190158822775",
    "contentFolderId": null,
    "contentGroupId": 29973821837,
    "abTestId": null,
    "languageVariantId": 190158822775,
    "languageCode": "en",
...
<script type="text/javascript" id="hs-script-loader" async defer src="/hs/scriptloader/53.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
<!-- End of HubSpot Analytics Code -->


<script type="text/javascript" nonce="edVKcqp1NO1p/3x9J5++Tg==">
var hsVars = {
    render_id: "695d9140-7a2f-4366-9e08-25b0e1724ed1",
    ticks: 1779358203921,
    page_id: 190158822775,
    ...
    analytics_page_id: "190158822775",
    category_id: 3,
    folder_id: 0,
...
<script defer src="/hs/hsstatic/HubspotToolsMenu/static-1.640/js/index.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
...
<!-- HREFLANG MACRO -->
  ...
  <script src="//www.hubspot.com/wt-assets/static-files/6.1.6/styleguide/scripts.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
  


<script type="text/javascript" src="https://static.hsappstatic.net/affiliates-landing-embed/ex/referral.js" nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
...
<script src="https://js.hubspot.com/ut-js/hubspot-dot-com.js" async nonce="edVKcqp1NO1p/3x9J5++Tg=="></script>
